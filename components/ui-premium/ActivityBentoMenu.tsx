    ...
    <SquishyCard padding="sm" className={className}>
        ...
        <div className="grid grid-cols-3 gap-3">
            ...
            <SquishyCard 
                interactive 
                padding="sm" 
                className="flex flex-col items-center gap-1.5 bg-zinc-800/20"
                onClick={() => onOpen('run')}
            >
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-emerald-400/10">
                    <svg className="w-4 h-4 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-cyan-400/10">
                    <svg className="w-4 h-4 text-cyan-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-amber-400/10">
                    <svg className="w-4 h-4 text-amber-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
