        ...
        <div className="h-full w-full relative flex flex-col">
            ...
            <div className="fixed top-0 left-0 right-0 z-40 p-4 max-w-3xl mx-auto flex justify-between items-start pointer-events-none">
                <Button 
                    ...
                    className="pointer-events-auto bg-surface-bg/40 backdrop-blur-md !p-3 rounded-full border border-white/10 text-white hover:bg-surface-bg/60 [&_svg]:rotate-180 shadow-lg active:scale-95"
                />
                    ...
                    <button
                        ...
                        className={`p-3 rounded-full backdrop-blur-md border transition-all shadow-sm active:scale-95 ${
                            isFavorite 
                                ...
                                : 'bg-surface-bg/40 border-white/10 text-white hover:bg-surface-bg/60'
                        }`}
                    >
                        <StarIcon className="w-5 h-5" />
                    </button>
                    {recipe.type === 'user' && (
                        <button onClick={onGoToEditor} className="p-3 bg-surface-bg/40 backdrop-blur-md border border-white/10 rounded-full text-white hover:bg-surface-bg/60 transition-all shadow-sm active:scale-95">
                ...
                <div className="relative w-full h-[55vh]">
                    ...
                    <div className="absolute bottom-16 left-0 right-0 px-6 pb-2 z-10">
                        <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg bg-brand-accent/20 border border-brand-accent/30 mb-3 backdrop-blur-md">
                            ...
                            <span className="text-[9px] font-bold text-white uppercase tracking-widest">{recipe.mealType || 'General'}</span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-black text-white uppercase tracking-tight leading-none drop-shadow-sm">
                            {recipe.name}
                        </h1>
                    </div>
                </div>
